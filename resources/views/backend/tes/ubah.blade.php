...
<div class="row">
    <div class="col-md-12">
		...
		<p>
			{!! Form::label('label', 'Masukkan Label', ['class'=>'control-label']) !!}
			{!! Form::textarea('label', $data->label, array('id' => 'nama', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>
		<p>
			{!! Form::label('nomor', 'Masukkan Nomor', ['class'=>'control-label']) !!}
			{!! Form::text('nomor', $data->nomor, array('id' => 'nama', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
		</p>

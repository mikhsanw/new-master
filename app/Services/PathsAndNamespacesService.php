...
class PathsAndNamespacesService
{
    ...
    {
        return $this->getRealpathBase('app'.DIRECTORY_SEPARATOR.'Http'.DIRECTORY_SEPARATOR.'Controllers'.DIRECTORY_SEPARATOR.'Backend');
    }
    ...
    {
        return $this->getRealpathBase('app').DIRECTORY_SEPARATOR.'Model';
    }

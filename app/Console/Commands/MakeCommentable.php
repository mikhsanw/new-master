...
use App\Services\Commentable\EditCommentableView;
use App\Services\Commentable\MakeCommentableRequestService;
use App\Services\Commentable\MakeCommentableControllerService;
...
class MakeCommentable extends Command
{
    ...
    private function setNameModelRelationship($namingConvention)
    {
        ...
        $correctNameOtherModel = ucfirst(Ucwords($nameOtherModel));
